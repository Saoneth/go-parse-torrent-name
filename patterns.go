...
var patterns = []struct {
	...
	{"audio", false, reflect.String, regexp.MustCompile(`(?i)\b((MP3|DDP?5\.?1|Dual[\- ]Audio|LiNE|H?DTS|AAC[.-][HL]C|AAC(?:.?2\.0|.?5\.1|.?7\.1)?|AC3(?:.?2\.0|.?5\.1|.?7\.1)?))\b`)},
	...
	{"language", false, reflect.String, regexp.MustCompile(`(?i)\b((rus\.eng|ita\.eng|multi|dual))\b`)},
	{"sbs", false, reflect.String, regexp.MustCompile(`(?i)\b(((?:Half-)?SBS))\b`)},
	{"container", false, reflect.String, regexp.MustCompile(`(?i)\b((MKV|AVI|MP4|TS))\b`)},
